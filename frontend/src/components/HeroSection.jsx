...
const HeroSection = () => {
    return (
        <div className="w-full min-h-[80vh] flex flex-col justify-start items-center mt-46 -mb-20 gap-4">
            ...
            <p className='w-[80%] px-2 lg:w-[30%]  text-center text-gray-800 font-semibold'>Design that converts, grows businesses, and delivers where it matters.</p>
            <div class="lg:w-[20%] p-2 bg-gradient-to-b from-indigo-500 to-indigo-900 rounded-[47.86px] shadow-[0_130px_35px_rgba(79,70,229,0.01),0_75px_36px_rgba(79,70,229,0.03),0_42px_30px_rgba(79,70,229,0.08),0_18px_22px_rgba(79,70,229,0.14),0_4px_12px_rgba(79,70,229,0.16)] opacity-100 will-change-transform">
